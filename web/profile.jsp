    ...
    <div class="container-fluid display-table">
        <div class="row display-table-row">
            ...
            <div class="col-md-10 col-sm-11 display-table-cell v-align">
                ...
                <tr>
                    <td><b>Profession: </b> </td><td> <%=session.getAttribute("kaam") %></td>
                </tr>
                <tr>
                    <td><b>Mobile No: </b> </td><td> <%=session.getAttribute("mobile") %></td>
                </tr>
               <tr>
                    <td><b>E-mail:  </b> </td><td> <%=session.getAttribute("mail") %></td>
                </tr>
                <tr>
                    <td><b>Photo: </b> </td><td style="text-align: center;"> <img src="<%=ph%>" height="80px" weight="70px" style="border-right: 50%; border:1px solid #0e1a35;"></td>
                </tr>
                <tr >
